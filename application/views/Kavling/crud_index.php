...
<div class="w-screen h-[450px] bg-indigo-600">
	<div class="px-4 mx-auto max-w-screen-xl text-center pt-16">
		<h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Master Kavling</h1>
		...
		<div class="relative w-full max-w-md max-h-full">
			...
			<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
				...
				<div class="px-6 py-6 lg:px-8">
					<h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Data Kavling</h3>
					<form class="space-y-6" action="<?php echo site_url('Kavling/Insert') ?>" method="POST">
						<div>
							<label for="no_blok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No Blok</label>
							<input type="text" name="no_blok" id="no_blok" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="" required>
						</div>
						<div>
							<label for="nama_blok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Blok</label>
							<input type="text" name="nama_blok" id="nama_blok" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="" required>
						</div>
						<div>
							<label for="lokasi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lokasi</label>
							<input type="text" name="lokasi" id="lokasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="" required>
						</div>
						<!-- <div>
	...
	<div id="update-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
		<div class="relative w-full max-w-md max-h-full">
			...
			<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
				...
				<div class="px-6 py-6 lg:px-8">
					<h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Update Data Kavling</h3>
					<form class="space-y-6" action="<?php echo site_url('Kavling/Update') ?>" method="POST">
		...
		<div class="relative p-4 w-full max-w-md h-full md:h-auto">
			...
			<div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
				...
				<div class="flex justify-center items-center space-x-4">
					...
					<form action="<?php echo site_url('Kavling/Delete') ?>" method="post">
...
<script>
	...
	function handleDeleteButtonClick(button) {
		...
		DeleteInput.value = data.kd_blok; // Replace 'no_blok' with the actual key from your JSON data
	...
	function populateUpdateModal(button) {
		...
		var lokasi = updateModal.querySelector('input[name="lokasi"]');
		var nama_blok = updateModal.querySelector('input[name="nama_blok"]');
		var no_blok = updateModal.querySelector('input[name="no_blok"]');
		...
		nama_blok.value = data.nama_blok;
		id.value = data.kd_blok;
		no_blok.value = data.no_blok;
